...
class Tokenizer:
    """An LLM tokenizer backed by local ``tokenizer.json`` or ``.st`` data."""

    @staticmethod
    def from_file(
        path: str, st_cache: bool = False
    ) -> "Tokenizer": ...
    @staticmethod
    ...
    def encode(self, input: str, add_special_tokens: bool = True) -> Encoding: ...
    def encode_batch(
        self, inputs: list[str], add_special_tokens: bool = True
    ) -> list[Encoding]: ...
