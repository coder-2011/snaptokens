...
int st_tokendagger_encode(void* handle, const uint8_t* text, size_t text_len,
                          NativeBuffer* output, NativeBuffer* error) ST_NOEXCEPT;
...
int st_tokendagger_pcre2_info(char* version, size_t version_capacity,
                              uint32_t* jit_available, uint32_t* header_major,
                              uint32_t* header_minor) ST_NOEXCEPT;
